...
public class ListActivityDirectories extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(checkPermissions() == false) {
            try {
                ActivityCompat.requestPermissions((Activity) ListActivityDirectories.this, new String[]{Manifest.permission.READ_EXTERNAL_STORAGE}, 3);
            } catch (Exception e){
                e.printStackTrace();
                throw e;
            }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_list_activity_directories, menu);
        return true;
    }
    ...
    public void startImageActivity(View view) {
        Intent startnext;
        startnext = new Intent(ListActivityDirectories.this,
          ShowImage.class);
    ...
    private boolean checkPermissions() {
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            int granted = ContextCompat.checkSelfPermission(ListActivityDirectories.this, Manifest.permission.READ_EXTERNAL_STORAGE);
